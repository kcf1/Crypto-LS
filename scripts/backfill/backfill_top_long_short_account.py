"""
Backfill Top Long/Short Account: ~30 days, 5m period, all symbols.
Binance retains ~30 days. Run from project root: python scripts/backfill/backfill_top_long_short_account.py
"""
...
def main():
    ...
    logger.info("Top Long/Short Account backfill: %s symbols, period=%s, ~30 days", len(symbols), PERIOD)
