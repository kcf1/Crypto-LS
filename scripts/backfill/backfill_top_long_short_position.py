"""
Backfill Top Long/Short Position: ~30 days, 5m period, all symbols.
Binance retains ~30 days. Run from project root: python scripts/backfill/backfill_top_long_short_position.py
"""
...
def main():
    ...
    logger.info("Top Long/Short Position backfill: %s symbols, period=%s, ~30 days", len(symbols), PERIOD)
